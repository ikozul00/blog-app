 ...
 */
final class Version20231104192733 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP last_edited, DROP reply_to_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD last_edited DATETIME DEFAULT NULL, ADD reply_to_id INT DEFAULT NULL');
    }
}
